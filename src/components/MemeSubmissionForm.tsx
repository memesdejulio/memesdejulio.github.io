...
const MemeSubmissionForm: React.FC<MemeSubmissionFormProps> = ({ date, onBack }) => {
  
  const handleRedirectToGitHub = () => {
    window.open('https://github.com/urielsalis/july-meme-calendar#contribuir-memes', '_blank');
  };
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
          <div className="text-center space-y-6">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Para mantener la calidad y organización de los memes, aceptamos contribuciones a través de Pull Requests en GitHub.
            </p>
              ...
              <div className="flex items-start">
                ...
                <div className="text-left">
                  ...
                  <ol className="text-blue-700 space-y-2">
                    ...
                    <li>2. Agrega tu meme en <code className="bg-blue-100 px-1 rounded">public/memes/{format(date, "d")}/</code></li>
                    <li>3. Actualiza el archivo <code className="bg-blue-100 px-1 rounded">manifest.json</code></li>
            ...
            <p className="text-sm text-gray-500">
              El enlace te llevará a la documentación completa en el repositorio de GitHub
            </p>
          </div>
        </div>
      </div>
