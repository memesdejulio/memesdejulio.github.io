...
const Memes = () => {
	...
	const handleDateSelect = (date: Date | undefined) => {
		if (date && date.getMonth() === 6 && date.getFullYear() === currentYear) {
			// Only allow July dates of current year
							...
							<div className="hidden md:block">
								<Calendar
									...
									classNames={{
										...
										head_row: 'flex mb-4',
										head_cell:
											'text-gray-600 rounded-md w-16 h-16 font-semibold text-xl flex items-center justify-center',
